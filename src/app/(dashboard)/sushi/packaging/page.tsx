...
const DEFAULT_FORM = { name: "", quantity: 0, unit: "个", lowThreshold: 0, notes: "" };
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm">
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div>
                ...
                <input type="number" min="0" value={form.lowThreshold} onChange={e => setForm(f => ({ ...f, lowThreshold: Number(e.target.value) }))}
                  className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-400" />
              </div>
              <div>
